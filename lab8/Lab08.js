...
tb.style.cssText="margin:100px auto 60px auto;width:600px;table-layout:fixed;";
var h3=document.getElementsByTagName("h3")[0];
h3.style.cssText="text-align: center;margin-top:30px;";
...
for (var i = 0, len = dots.length; i < len; i++){
    (function(i){
        dots[i].onclick = function () {
            ...
            wrap.style.left = (parseInt(wrap.style.left) + mar * 600)+"px";
            index = i;
            changeDot();
        }
    })(i);
...
function editCell(event){
    ...
    if(currentCell.tagName.toLowerCase() == "td"){
        ...
        input.type = 'text';
        input.style.cssText="outline: none;width:98%;height:100%;";
...
window.onload=function() {
    document.getElementsByTagName("table")[0].onclick=editCell;
}
/*********************************************end*************************************/